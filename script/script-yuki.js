const SCRIPT_YUKI_HTML = `<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Yuki Store - Script Yuki AI</title>
    <meta property="og:title" content="Yuki Store - Script Yuki AI">
...
<body class="font-inter">
    ...
    <aside id="sidebar" class="overflow-x-hidden overflow-y-hidden max-w-full">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="?page=script-yuki" class="nav-item active">
        ...
        <div class="page-container">
            <div class="section-header">
                <div class="section-icon bg-violet-50">
                    <i data-lucide="code-2" class="w-5 h-5 text-violet-500"></i>
                </div>
                <div>
                    <h2 class="text-xl font-bold text-[var(--text-primary)]">Script Yuki AI</h2>
                    <p class="text-sm text-[var(--text-muted)]">Script bot WhatsApp terbaik dan terupdate</p>
                </div>
            </div>
            <div class="glass-card p-8 mb-10" style="background: linear-gradient(135deg, rgba(139,92,246,0.08), rgba(236,72,153,0.06), rgba(59,130,246,0.04)); border-color: rgba(139,92,246,0.15);">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                    <div class="flex-1">
                        ...
                        <ul class="space-y-2.5 mb-6">
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>1000+ Fitur Siap Pakai</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>Tangguh & Auto Reconnect</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>Sangat Ringan & Cepat</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>Rapi & Bersih (Clean Code)</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>Baileys Tech Modern</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>Free Update Sampai Pensiun</li>
                            <li class="flex items-center gap-2.5 text-sm text-[var(--text-secondary)]"><i data-lucide="check-circle-2" class="w-4.5 h-4.5 text-emerald-500 flex-shrink-0"></i>+Bonus Free Panel Unlimited</li>
                        </ul>
                    </div>
                    <div class="flex flex-col items-center lg:items-end gap-4">
                        <div class="text-center lg:text-right">
                            <p class="text-sm text-[var(--text-muted)] line-through">Rp 150.000</p>
...
if (typeof YUKI !== 'undefined' && YUKI.registerPage) {
    YUKI.registerPage('script-yuki', SCRIPT_YUKI_HTML);
}

console.log('✅ YUKI STORE - Script Yuki page registered');