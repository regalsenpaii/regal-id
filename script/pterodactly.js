...
<body class="font-inter">
    ...
    <aside id="sidebar" class="overflow-x-hidden overflow-y-hidden max-w-full">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="?page=pterodactyl" class="nav-item active">
    ...
    <main id="main-content">
        <div class="page-container">
            <div class="section-header">
                ...
                <div>
                    <h2 class="text-xl font-bold text-[var(--text-primary)]">Panel Pterodactyl</h2>
                    <p class="text-sm text-[var(--text-muted)]">Pilih kapasitas panel sesuai kebutuhan Anda</p>
                </div>
            </div>
            <div id="panel-grid" class="products-grid mb-10"></div>
...
console.log('✅ YUKI STORE - Pterodactyl page registered');