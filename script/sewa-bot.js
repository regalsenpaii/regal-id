const SEWA_BOT_HTML = `<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Yuki Store - Sewa Bot & Premium</title>
    <meta property="og:title" content="Yuki Store - Sewa Bot & Premium">
...
<body class="font-inter">
    ...
    <aside id="sidebar" class="overflow-x-hidden overflow-y-hidden max-w-full">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="?page=sewa-bot" class="nav-item active">
    ...
    <main id="main-content">
        <div class="page-container">
            <div class="section-header">
                ...
                <div>
                    <h2 class="text-xl font-bold text-[var(--text-primary)]">Sewa Bot & VIP Premium</h2>
                    <p class="text-sm text-[var(--text-muted)]">Layanan bot dan premium user terbaik</p>
                </div>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
                <div class="glass-card glass-card-green p-6">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-100">
                            <i data-lucide="bot" class="w-6 h-6 text-white"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-[var(--text-primary)]">Jasa Sewa Bot Yuki AI</h3>
                            <p class="text-xs text-[var(--text-muted)]">Bot WhatsApp Canggih</p>
                        </div>
                    </div>
                    <div class="space-y-3 mb-5">
                        <div class="flex items-center justify-between p-3 rounded-xl bg-[var(--input-bg)] border border-[var(--border-color)]">
                            <div class="flex items-center gap-2"><i data-lucide="calendar" class="w-4 h-4 text-blue-500"></i><span class="text-sm font-medium text-[var(--text-secondary)]">Bulanan</span></div>
                            <span class="text-sm font-bold text-blue-600">Rp 15.000</span>
                        </div>
                        <div class="flex items-center justify-between p-3 rounded-xl bg-[var(--input-bg)] border border-[var(--border-color)]">
                            <div class="flex items-center gap-2"><i data-lucide="infinity" class="w-4 h-4 text-emerald-500"></i><span class="text-sm font-medium text-[var(--text-secondary)]">Permanen</span></div>
                            <span class="text-sm font-bold text-emerald-600">Rp 80.000</span>
                        </div>
                    </div>
                    <button onclick="openModal('Jasa Sewa Bot Yuki AI - Bulanan', 15000)" class="btn-primary w-full mb-2"><i data-lucide="shopping-cart" class="w-4 h-4"></i>Beli Bulanan</button>
                    <button onclick="openModal('Jasa Sewa Bot Yuki AI - Permanen', 80000)" class="btn-primary btn-emerald w-full"><i data-lucide="shopping-cart" class="w-4 h-4"></i>Beli Permanen</button>
                </div>
                <div class="glass-card p-6">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-100">
                            <i data-lucide="crown" class="w-6 h-6 text-white"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-[var(--text-primary)]">Premium User Bot Yuki</h3>
                            <p class="text-xs text-[var(--text-muted)]">Akses Premium Eksklusif</p>
                        </div>
                    </div>
                    <div class="space-y-3 mb-5">
                        <div class="flex items-center justify-between p-3 rounded-xl bg-[var(--input-bg)] border border-[var(--border-color)]">
                    ...
                    <button onclick="openModal('Premium User Bot Yuki - Bulanan', 5000)" class="btn-primary btn-amber w-full mb-2"><i data-lucide="shopping-cart" class="w-4 h-4"></i>Beli Bulanan</button>
                    <button onclick="openModal('Premium User Bot Yuki - Permanen', 50000)" class="btn-primary btn-emerald w-full"><i data-lucide="shopping-cart" class="w-4 h-4"></i>Beli Permanen</button>
                </div>
            </div>
